// A (very) basic kernel TTY

#include "font.h"
#include "memory.h"

physical_address_t framebuffer_addr = 0;
uint32_t pitch = 0;
...
void terminal_initialize(physical_address_t _framebuffer_addr, uint32_t _pitch, uint32_t width, uint32_t height)
{
